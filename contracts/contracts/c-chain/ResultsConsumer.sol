...
contract ResultsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    event ResultReceived(uint256 indexed matchId, uint8 outcome, uint256 homeId, uint256 awayId);
    ...
    function fulfillRequest(
        ...
        IChainlinkProxy(owner()).fulfillAndSendResult(matchId, outcome, homeId, awayId);
    }
}